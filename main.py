...
from utils.errors import errores_activos
pygame.init()
...
while True:
    ...
    elif escena == "sala_vigilancia":
        escena_actual = sala_vigilancia(pantalla, ANCHO, ALTO, entrada_por=origen)
